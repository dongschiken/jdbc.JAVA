...
<script>
	...
	// [1]
	<%-- jsp 주석처리 //const rdb_list = document.getElementByName("subject");
	const rdb_list = document.querySelectorAll("input[name=subject]");
	//alert(rdb_list.length)
	for (var i = 0; i < rdb_list.length; i++) {
		const element = rdb_list[i];
